...
import numpy as np
import torch
# from tqdm import tqdm # Ser� manejado por cache_latents.encode_datasets o ProgressBar de ComfyUI
...
from train_utils.model_utils import str_to_dtype # Asumiendo que model_utils est� en dataset/utils/
from wan.configs import wan_i2v_14B # Para defaults de clip
from wan.modules.vae import WanVAE
from wan.modules.clip import CLIPModel
import cache_latents as base_cache_latents_script # Renombrar para claridad
